    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative p-2" x-data="{ openNotifications: false }">
                    ...
                    {{ auth()->user()->unreadNotifications->count() }}
                        ...
                        <x-slot name="content">
                            <div x-show="openNotifications" @click.away="openNotifications = false"
                                 class="bg-white border rounded-md shadow-md p-4 max-w-sm mx-auto">

                                <h3 class="font-bold text-lg mb-4 text-gray-800">Notifications</h3>

                                @forelse(auth()->user()->unreadNotifications as $notification)
                                    <div class="mb-2 text-gray-700">
                                        {{ isset($notification->data['message']) ? $notification->data['message'] : 'No message' }}
                                    </div>
                                @empty
                                ...
                                <a href="{{ route('notifications.index') }}"
                                   class="block mt-4 text-blue-600 hover:underline focus:outline-none focus:text-blue-800">
